...
class _GraficaProductosScreenState extends State<GraficaProductosScreen> {
  ...
  Color _colorBarra(int index, bool tocado) {
    ...
    return tocado ? color : color.withOpacity(0.75);
  }
        ...
        body: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text('Solo administradores pueden ver esta gráfica',
                    ...
                    : ListView(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                // Info del producto tocado
                                if (_touchedIndex >= 0 &&
                                    _touchedIndex < _productos.length) ...[
                                  _tarjetaDetalle(
                                      _productos[_touchedIndex], _touchedIndex),
                                  const SizedBox(height: 12),
                                ],
  ...
  // ── Tarjeta de detalle al tocar la barra ─────────────────
  Widget _tarjetaDetalle(Map p, int index) {
    ...
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        color: _colorBarra(index, true).withOpacity(0.1),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: _colorBarra(index, true).withOpacity(0.4)),
      ),
      child: Row(
        children: [
          Container(
